...
`@ni/fast-colors` includes a number of color classes and utilities designed to make parsing and manipulating colors easy, fast, and light-weight. This `@ni/fast-colors` library is a fork of [`@microsoft/fast-colors`](https://www.npmjs.com/package/@microsoft/fast-colors).
