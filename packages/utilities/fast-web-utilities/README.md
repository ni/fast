...
This package is a collection of utilities intended to be used for web projects. This `@ni/fast-web-utilities` library is a fork of [`@microsoft/fast-web-utilities`](https://www.npmjs.com/package/@microsoft/fast-web-utilities).
